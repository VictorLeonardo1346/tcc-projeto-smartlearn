...
function startGame() {
    // Embaralha as questões antes de começar o quiz
...
function displayNextQuestions() {
    ...
    $questionText.textContent = shuffledQuestions[currentQuestionsIndex].question;
    shuffledQuestions[currentQuestionsIndex].answers.forEach(answer => {
...
function shuffleQuestions(questions) {
    // Algoritmo de Fisher-Yates para embaralhar as perguntas
